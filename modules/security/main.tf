...
# IAM Policy para EC2 - Acceso básico
resource "aws_iam_role_policy" "ec2_basic" {
  name = "${var.project_name}-ec2-basic-policy"
...
# IAM Policy para EC2 - SNS y SQS (se actualizará cuando se cree el módulo messaging)
resource "aws_iam_role_policy" "ec2_messaging" {
  count = var.enable_messaging_permissions ? 1 : 0
